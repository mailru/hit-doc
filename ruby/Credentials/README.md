...
### 1. Использование файла, содержащего AWS credentials ( используя credential profiles )
...
### 3. Использование хеша Aws.config
...
### 4. Задание ключей доступа при конфигурации клиента
...
```
### 2. Использование хеша Aws.config
Задайте учетные данные в своем коде, обновив значения в хэше Aws.config.
```
Aws.config.update({region: 'ru-msk'})
```
### 3. Задание региона при конфигурации клиента
```
